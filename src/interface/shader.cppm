...
export namespace pragma::scenekit {
	extern const std::string COLORSPACE_AUTO;
	extern const std::string COLORSPACE_RAW;
	extern const std::string COLORSPACE_SRGB;
	...
	class DLLRTUTIL GroupNodeDesc : public NodeDesc {
	  ...
	  protected:
		...
		pragma::scenekit::NodeDesc &AddImageTextureNode(const std::optional<std::string> &fileName, const std::optional<Socket> &fileNameSocket, TextureType type);
	...
	class DLLRTUTIL Shader final : public std::enable_shared_from_this<Shader>, public BaseObject {
	  public:
		...
		std::shared_ptr<pragma::scenekit::GroupNodeDesc> combinedPass = nullptr;
		std::shared_ptr<pragma::scenekit::GroupNodeDesc> albedoPass = nullptr;
		std::shared_ptr<pragma::scenekit::GroupNodeDesc> normalPass = nullptr;
		std::shared_ptr<pragma::scenekit::GroupNodeDesc> depthPass = nullptr;
	...
	constexpr inline auto *NODE_MATH = "math";
	constexpr inline auto *NODE_HSV = "hsv";
	constexpr inline auto *NODE_SEPARATE_XYZ = "separate_xyz";
	constexpr inline auto *NODE_COMBINE_XYZ = "combine_xyz";
	constexpr inline auto *NODE_SEPARATE_RGB = "separate_rgb";
	constexpr inline auto *NODE_COMBINE_RGB = "combine_rgb";
	constexpr inline auto *NODE_GEOMETRY = "geometry";
	constexpr inline auto *NODE_CAMERA_INFO = "camera_info";
	constexpr inline auto *NODE_IMAGE_TEXTURE = "image_texture";
	constexpr inline auto *NODE_NORMAL_TEXTURE = "normal_texture";
	constexpr inline auto *NODE_ENVIRONMENT_TEXTURE = "environment_texture";
	constexpr inline auto *NODE_MIX_CLOSURE = "mix_closure";
	constexpr inline auto *NODE_ADD_CLOSURE = "add_closure";
	constexpr inline auto *NODE_BACKGROUND_SHADER = "background_shader";
	constexpr inline auto *NODE_TEXTURE_COORDINATE = "texture_coordinate";
	constexpr inline auto *NODE_UVMAP = "uvmap";
	constexpr inline auto *NODE_MAPPING = "mapping";
	constexpr inline auto *NODE_SCATTER_VOLUME = "scatter_volume";
	constexpr inline auto *NODE_EMISSION = "emission";
	constexpr inline auto *NODE_COLOR = "color";
	constexpr inline auto *NODE_ATTRIBUTE = "attribute";
	constexpr inline auto *NODE_LIGHT_PATH = "light_path";
	constexpr inline auto *NODE_TRANSPARENT_BSDF = "transparent_bsdf";
	constexpr inline auto *NODE_TRANSLUCENT_BSDF = "translucent_bsdf";
	constexpr inline auto *NODE_DIFFUSE_BSDF = "diffuse_bsdf";
	constexpr inline auto *NODE_NORMAL_MAP = "normal_map";
	constexpr inline auto *NODE_PRINCIPLED_BSDF = "principled_bsdf";
	constexpr inline auto *NODE_PRINCIPLED_VOLUME = "principled_volume";
	constexpr inline auto *NODE_TOON_BSDF = "toon_bsdf";
	constexpr inline auto *NODE_GLASS_BSDF = "glass_bsdf";
	constexpr inline auto *NODE_GLOSSY_BSDF = "glossy_bsdf";
	constexpr inline auto *NODE_OUTPUT = "output";
	constexpr inline auto *NODE_VECTOR_MATH = "vector_math";
	constexpr inline auto *NODE_MIX = "mix";
	constexpr inline auto *NODE_RGB_TO_BW = "rgb_to_bw";
	constexpr inline auto *NODE_INVERT = "invert";
	constexpr inline auto *NODE_VECTOR_TRANSFORM = "vector_transform";
	constexpr inline auto *NODE_RGB_RAMP = "rgb_ramp";
	constexpr inline auto *NODE_LAYER_WEIGHT = "layer_weight";
	constexpr inline auto *NODE_NOISE_TEXTURE = "noise_texture";
	constexpr inline auto *NODE_AMBIENT_OCCLUSION = "ambient_occlusion";

	constexpr inline auto *NODE_VOLUME_CLEAR = "volume_clear";
	constexpr inline auto *NODE_VOLUME_HOMOGENEOUS = "volume_homogeneous";
	constexpr inline auto *NODE_VOLUME_HETEROGENEOUS = "volume_heterogeneous";
	static_assert(NODE_COUNT == 44, "Increase this number if new node types are added!");
};

export DLLRTUTIL std::ostream &operator<<(std::ostream &os, const pragma::scenekit::NodeDesc &desc);
export DLLRTUTIL std::ostream &operator<<(std::ostream &os, const pragma::scenekit::GroupNodeDesc &desc);
